# agent-date-context Specification

## Purpose
Ensures every agent prompt (main agent and subagent) includes today's date so agents can reason about time-sensitive context without needing to fetch it themselves.
