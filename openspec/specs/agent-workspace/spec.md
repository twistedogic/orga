...
## Purpose
Per-ticket workspace directory for agent file I/O. Provides isolated, path-safe read/write/list access to a local filesystem directory rooted at `<workspace.path>/<sanitized_ticket_id>/`.
