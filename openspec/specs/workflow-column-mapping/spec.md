# workflow-column-mapping Specification

## Purpose
Defines the configuration and runtime behavior for mapping board columns to workflow prompts injected into ticket output.
