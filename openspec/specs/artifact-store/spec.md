...
## Purpose
Defines the `ArtifactStore` trait, models (`ArtifactMeta`, `Artifact`), and `build_artifact_store` factory for backend-agnostic artifact storage scoped per ticket and agent.
