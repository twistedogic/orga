...
## Purpose
Reusable generic LLM tool-call loop abstraction that encapsulates the completion-request / tool-dispatch / history-append cycle shared by all agent variants (main agent, subagent, sleep-time agent, defrag agent).
